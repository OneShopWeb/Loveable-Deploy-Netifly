...
### 1. Create a Perplexity account and API key
...
### 2. Connect Perplexity to Lovable
...
## How to delete a Perplexity connection

Workspace **admins** and **owners** can delete Perplexity connections.

Deleting a connection is permanent and cannot be undone. It will remove the credentials from all linked projects, and any apps depending on Perplexity will stop working until a new connection is added.
