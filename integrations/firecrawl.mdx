...
## How to delete a Firecrawl connection

Workspace **admins** and **owners** can delete Firecrawl connections.

Deleting a connection is **permanent** and **cannot be undone**. It will remove the credentials from all linked projects, and any apps depending on Firecrawl will stop working until a new connection is added.
